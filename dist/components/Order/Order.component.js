...
var Order = _react2['default'].createClass({ 
  ...
  render: function render() {
    ...
    var cancelOrder = _react2['default'].createElement('a', { className: 'cancel-order-button button', href: cancelLink }, 'Annuller');
    ...
    var orderLink = '/work/receipt?ids=' + ids + '&pickupAgency=' + pickupAgency + '&borrowerId=' + borrowerId + '&title=' + 
    encodeURIComponent(title) + '&creator=' + encodeURIComponent(creator) + '&type=' + encodeURIComponent(type);

    var placeOrder = _react2['default'].createElement('a', { className: 'place-order-button button', href: orderLink }, 'Ok');

    var ordering = _react2['default'].createElement('div', { className: 'order--info' }, 
    _react2['default'].createElement('div', { className: 'order--headline' }, 'Du er i gang med at bestille:'), 
    _react2['default'].createElement('div', { className: 'order--bibliographic' }, orderInfo), 
    _react2['default'].createElement('div', { className: 'order--library' }, libraryInfo));
    ...
    if (pickupAgency === '' || borrowerId === '') {
      ...
      ordering = _react2['default'].createElement('div', { className: 'order--info' }, 
      _react2['default'].createElement('div', { className: 'order--headline' }, orderHeadline), 
      _react2['default'].createElement('div', { className: 'order--bibliographic' }, orderInfo), 
      _react2['default'].createElement('a', { className: 'library-button button', href: '/profile' }, 'Tilføj ', buttonText));}



    return _react2['default'].createElement('div', { className: 'order--container' }, 
    _react2['default'].createElement('div', { className: 'image small-4 medium-6 large-4' }, 
    coverImage), 

    _react2['default'].createElement('div', { className: 'order small-8 medium-6 large-4' }, 
    ordering), 

    cancelOrder, 
    placeOrder);} });exports['default'] = 





Order;module.exports = exports['default'];