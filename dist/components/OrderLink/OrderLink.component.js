...
var _OrderLinkStoreJs = require('./OrderLink.store.js');

var _OrderLinkStoreJs2 = _interopRequireDefault(_OrderLinkStoreJs);
  ...
  render: function render() {
    ...
    if (this.props.workTypeOrder === false) {
      return _react2['default'].createElement(
        'div',
        { className: 'no-mobile-order', 'data-canorder': this.state.canOrder, key: this.props.key },
        no_order
      );
    }
