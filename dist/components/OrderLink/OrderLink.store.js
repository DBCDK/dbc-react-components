...
'reflux');var _reflux2 = _interopRequireDefault(_reflux);var _OrderLinkActionJs = require(
...
var OrderLinkStore = _reflux2['default'].createStore({ 
  ...
  update: function update(response) {
    ...
    if (response.result.hasOwnProperty('canOrder')) {
      store[pid] = response.result.canOrder;} else 
...
OrderLinkStore;module.exports = exports['default'];