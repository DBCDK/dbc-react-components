...
var _OrderLinkOrderLinkComponentJs = require('../OrderLink/OrderLink.component.js');

var _OrderLinkOrderLinkComponentJs2 = _interopRequireDefault(_OrderLinkOrderLinkComponentJs);
...
var OrderButton = _react2['default'].createClass({
  ...
  getOrderLink: function getOrderLink(m, userInfo, manifestations, userIsLoggedIn, index) {
    ...
    return _react2['default'].createElement(_OrderLinkOrderLinkComponentJs2['default'], {
      ...
      if (r.type === 'dbcaddi:hasOnlineAccess') {
        if (r.collection.indexOf('150015-erelic') !== -1 || r.collection.indexOf('150021-bibliotek') !== -1 || r.collection.indexOf('150021-fjern') !== -1) {
          ...
          return _react2['default'].createElement(
            'a',
            { className: 'online-link', href: r.link, key: index + '.' + i, target: '_blank' },
            online_link
          );
        }
      }
  ...
  createButtons: function createButtons(manifestations, userInfo, relations, profile) {
    var _this = this;
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'div',
      { className: 'work-container--order-buttons clearfix' },
      orderButtons
    );
  }
});
