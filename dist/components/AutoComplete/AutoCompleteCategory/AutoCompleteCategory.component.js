...
var AutoCompleteCategory = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    var rows = data.map(function (value, key) {
      return _react2['default'].createElement(_AutoCompleteRowAutoCompleteRowComponentJs2['default'], { href: value.href, image: value.image, imageComp: value.imageComp, key: key, text: value.text });
    });
