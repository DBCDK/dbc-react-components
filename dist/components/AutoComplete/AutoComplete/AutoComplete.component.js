...
'lodash');var _AutoCompleteCategoryAutoCompleteCategoryComponentJs = require(
'./../AutoCompleteCategory/AutoCompleteCategory.component.js');var _AutoCompleteCategoryAutoCompleteCategoryComponentJs2 = _interopRequireDefault(_AutoCompleteCategoryAutoCompleteCategoryComponentJs);
...
var AutoComplete = _react2['default'].createClass({ 
  ...
  getCategories: function getCategories() {
    ...
    (0, _lodash.forIn)(data, function (value, key) {
      ...
      _react2['default'].createElement(_AutoCompleteCategoryAutoCompleteCategoryComponentJs2['default'], { data: value.data, key: key, label: value.label }));});
  ...
  render: function render() {
    ...
    if (categories.length === 0) {
      ...
      _react2['default'].createElement('span', { className: 'autocomplete--category--label' }, this.props.errormessage)));} else 
    ...
    return htmlToRender;} });exports['default'] = 



AutoComplete;module.exports = exports['default'];