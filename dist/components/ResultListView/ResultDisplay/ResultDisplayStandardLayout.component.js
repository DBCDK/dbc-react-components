...
DisplayResultStandardLayout = (function (_React$Component) {_inherits(DisplayResultStandardLayout, _React$Component);
  function DisplayResultStandardLayout(props) {_classCallCheck(this, DisplayResultStandardLayout);
    _get(Object.getPrototypeOf(DisplayResultStandardLayout.prototype), 'constructor', this).call(this, props);}_createClass(DisplayResultStandardLayout, [{ key: 'render', value: 


    function render() {
      return (
        _react2['default'].createElement('div', { className: 'container' }, 
        _react2['default'].createElement('ul', { className: 'small-block-grid-2 medium-block-grid-3 large-block-grid-4' }, 
        this.props.workElement), 

        this.props.loader, 
        this.props.loadMoreButton));} }]);return DisplayResultStandardLayout;})(_react2['default'].Component);exports['default'] = DisplayResultStandardLayout;
...
DisplayResultStandardLayout.propTypes = { 
  loadMoreButton: _react2['default'].PropTypes.element, 
  loader: _react2['default'].PropTypes.element, 
  workElement: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.element) };module.exports = exports['default'];