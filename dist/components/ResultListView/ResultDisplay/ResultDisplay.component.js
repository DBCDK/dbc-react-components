...
var _ResultDisplayStandardLayoutComponent = require('./ResultDisplayStandardLayout.component');

var _ResultDisplayStandardLayoutComponent2 = _interopRequireDefault(_ResultDisplayStandardLayoutComponent);
...
var ResultDisplay = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    var workElement = result.map(function (work, i) {
      return _react2['default'].createElement(_DisplayBibliographicDataDisplayBibliographicDataComponentJs2['default'], {
    ...
    return _react2['default'].createElement(Layout, { loadMoreButton: loadMoreButton, loader: loader, workElement: workElement });
  }
});
