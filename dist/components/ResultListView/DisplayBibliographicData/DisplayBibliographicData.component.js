...
var BibliographicData = _react2['default'].createClass({
  ...
  getCoverComponent: function getCoverComponent(pids, workType) {
    ...
    if (this.props.coverImage) {
      ...
      CoverImage = _react2['default'].createElement(CoverComponent, { noCoverUrl: noCoverUrl, pids: pids, prefSize: this.props.coverImage.prefSize, rewriteImgUrl: this.props.coverImage.rewriteImgUrl });
    }
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'li',
      { 'data-work-id': firstPid },
      _react2['default'].createElement(
        'div',
        { className: 'work', 'data-work-id': firstPid, id: workid },
        _react2['default'].createElement(
          'a',
