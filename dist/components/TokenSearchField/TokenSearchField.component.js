...
var _utilsQueryStringUtilJs = require('../../utils/QueryString.util.js');
...
var SearchField = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'div',
      { className: 'token-searchfield', onKeyUp: this.onKey },
      _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'div',
            { className: 'large-24 columns' },
            _react2['default'].createElement(
              'div',
              { className: 'row collapse' },
              _react2['default'].createElement(
                'div',
                { className: 'small-20 columns' },
                _react2['default'].createElement(
                  'div',
                  { className: 'tokens' },
                  _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                ...
                _react2['default'].createElement('input', { className: 'button postfix', onClick: this.onSubmit, type: 'submit', value: 'Søg' })
              )
            )
          )
        )
