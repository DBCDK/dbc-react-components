...
'reflux');var _reflux2 = _interopRequireDefault(_reflux);var _ReceiptActionJs = require(
'./Receipt.action.js');var _ReceiptActionJs2 = _interopRequireDefault(_ReceiptActionJs);
...
var ReceiptStore = _reflux2['default'].createStore({ 
  ...
  update: function update(response) {
    ...
    if (response.result.hasOwnProperty('orderPlaced')) {
      store[pid] = response.result.orderPlaced;} else 
...
ReceiptStore;module.exports = exports['default'];