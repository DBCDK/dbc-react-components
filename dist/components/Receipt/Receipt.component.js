...
var _ReceiptStoreJs = require('./Receipt.store.js');

var _ReceiptStoreJs2 = _interopRequireDefault(_ReceiptStoreJs);
    ...
    if (store[this.props.receipt.ids.toString()] === true) {
      this.setState({
        ...
        backLink: _react2['default'].createElement(
          'a',
          { className: 'back-button button', href: backLink },
          'Afslut'
        )
      });
    } else {
  ...
  render: function render() {
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'div',
        { className: 'receipt small-12 medium-6 large-4' },
        _react2['default'].createElement(
          'div',
          { className: 'receipt--info' },
          _react2['default'].createElement(
            'div',
            { className: 'receipt--headline' },
            this.state.headline
          ),
          _react2['default'].createElement(
            'div',
            { className: 'receipt--bibliographic' },
            this.state.orderInfo
          ),
          _react2['default'].createElement(
            'div',
            { className: 'receipt--library' },
