...
var event = (0, _dbcNodeServiceproviderSocketclient2['default'])('placeOrder');

var ReceiptActions = _reflux2['default'].createAction({ 
  children: ['updated', 'failed'] });


ReceiptActions.listen(event.request);
event.response(ReceiptActions.updated);exports['default'] = 

ReceiptActions;module.exports = exports['default'];