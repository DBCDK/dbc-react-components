...
var FilterGuideList = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    var categoryItems = categories.map(function (category, i) {
      return _react2['default'].createElement(_FilterGuideListElementComponentJs2['default'], { element: category, key: i, select: select });
    });
