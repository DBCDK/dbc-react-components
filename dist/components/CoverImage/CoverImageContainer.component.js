...
var _CoverImageComponentJs = require('./CoverImage.component.js');

var _CoverImageComponentJs2 = _interopRequireDefault(_CoverImageComponentJs);

var _CoverImageStoreJs = require('./CoverImage.store.js');

var _CoverImageStoreJs2 = _interopRequireDefault(_CoverImageStoreJs);

var _CoverImageActionJs = require('./CoverImage.action.js');

var _CoverImageActionJs2 = _interopRequireDefault(_CoverImageActionJs);
...
var CoverImageContainer = _react2['default'].createClass({
  ...
  render: function render() {
    return _react2['default'].createElement(_CoverImageComponentJs2['default'], { imgurl: this.state.imgurl });
  }
});

exports['default'] = CoverImageContainer;
