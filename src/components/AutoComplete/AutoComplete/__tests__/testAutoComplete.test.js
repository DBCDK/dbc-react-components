...
describe('Test AutoComplete Component', () => {
  ...
  it('Assert hidden class not to be added when visible:true', () => {
    const rendered = TestUtils.renderIntoDocument(<AutoComplete visible={true}/>); // eslint-disable-line jsx-boolean-value
  ...
  it('Assert no results found message when data is empty', () => {
    const rendered = TestUtils.renderIntoDocument(<AutoComplete errormessage="Ingen resultater fundet" visible={true}/>); // eslint-disable-line jsx-boolean-value
